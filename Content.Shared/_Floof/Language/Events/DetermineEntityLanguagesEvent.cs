...
/// <summary>
///     Raised in order to determine the list of languages the entity can speak and understand at the current moment.
...
{
    /// <summary>
    ///     The list of all languages the entity can speak.
    ...
    /// <summary>
    ///     The list of all languages the entity can understand.
